...
<html>
    ...
    <body class="container-fluid" background="images/hbg.jpg">
        ...
        <div >
                ...
                Buy These books <input type="submit" value="Buy"> 
                </form>    
                </li>
                </ul>
        </div>
...
if ($result->num_rows > 0)
{
    ...
    while($row = mysqli_fetch_assoc($result))
    {
        ...
        $isb[$i]= $row["ISBN"];
        echo "<td> <form action='deletefromcart.php' name='delForm' method='post'> <input type='hidden' name='ISBNno'  value =" .$isb[$i] ." /> <input type='submit' class = 'button' value='Remove From Cart'/> </form>";
        $i++;
        echo "</tr>";
